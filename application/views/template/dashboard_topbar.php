	...
	<ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
		  ...
		  <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
		    ...
		    <div style="overflow-y:scroll;max-height:150px; line-height: 30px;" class="message">
		    	<!-- cek jumlah pesan masuk -->
		
		     </div>
		     <a class="dropdown-item text-center small text-gray-500" href="<?= base_url('admin/message/inbox') ?>">Lihat semua pesan</a>
